 ...
 */
$config['site_title']                 = "HMS";       // Site Title, example.com
$config['admin_email']                = "sss_sonfack@yahoo.com"; // Admin Email, admin@example.com
...
$config['track_login_attempts']       =  FALSE ;//TRUE;               // Track the number of failed login attempts for each user or ip.
...
$config['maximum_login_attempts']     = 1000 ;//3;                   // The maximum number of failed login attempts.
