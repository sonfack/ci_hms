...
class Auth extends CI_Controller {
	...
	public function index()
	{
		...
		if (!$this->ion_auth->logged_in())
		{
			...
			redirect($this->index.$this->session->userdata('group_id').'auth/login', 'refresh');
		}
		...
		else
		{
			 ...
			 * if(isset($_SESSION['group_id']) and $_SESSION['group_id'] === 1){
				...
				$this->template->view('auth/index',$this->data);
			}else{
				$this->logout();
			}
			* 
			*/
			...
			$this->_render_page('index.php/users/auth/index', $this->data);
		}
	}
	...
	public function change_password()
	{
		...
		if ($this->form_validation->run() == false)
		{
			...
			$this->template->view('auth/change_password', $this->data);
		}
		else
		{
	...
	public function forgot_password()
	{
		...
		if ($this->form_validation->run() == false)
		{
			...
			$this->data['message'] = (validation_errors()) ? validation_errors() : $this->session->flashdata('message');
			$this->template->view('auth/forgot_password', $this->data);
	...
	public function reset_password($code = NULL)
	{
		...
		if ($user)
		{
			...
			if ($this->form_validation->run() == false)
			{
				...
				// render
				$this->template->view('auth/reset_password', $this->data);
	...
	public function activate($id, $code=false)
	{
		...
		if ($activation and isset($_SESSION['group_id']) and $_SESSION['group_id'] === 1)
		{
	...
	public function deactivate($id = NULL)
	{
		...
		if ($this->form_validation->run() == FALSE)
		{
			...
			$this->data['identity'] = $this->session->userdata('identity');
			$this->template->view('users/auth/deactivate_user', $this->data);
	...
	public function create_user()
    {
		...
		'class' => 'form-control',
            ...
            if ( !$this->ion_auth->is_admin())
            {
			   $this->template->view('users/auth/create_user_all', $this->data);
               //$this->_render_page('users/auth/create_user_all', $this->data);
            }else{
				if(isset($_SESSION['group_id']) and $_SESSION['group_id'] === 1){
					$this->data['identity'] = $this->session->userdata('identity');
					
					$this->template->view('auth/create_user',$this->data);
				}else{
					$this->logout();
				}
	...
	public function edit_user($id)
	{
		...
		$this->data['identity'] = $this->session->userdata('identity');
		$this->template->view('auth/edit_user', $this->data);
	...
	public function create_group()
	{
		...
		else
		{
			...
			if(isset($_SESSION['group_id']) and $_SESSION['group_id'] === 1){
					...
					$this->template->view('auth/create_group',$this->data);
				}else{
					$this->logout();
				}
	...
	public function edit_group($id)
	{
		...
		$this->data['identity'] = $this->session->userdata('identity');
		$this->template->view('auth/edit_group', $this->data);
